    ...
    return (
        <div>
            ...
            <div className='absolute'>
                <img className='w-[100vw] h-[100vh] bg-cover' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCqFHhtVuOEAphkdvb3oPp4u5vcZuCyOQFTw&s" alt="banner" />
            </div>
            <form onSubmit={getInputData} className='flex flex-col w-3/12 p-12 my-36 left-0 right-0  mx-auto items-center justify-center absolute rounded-md bg-black opacity-90'>
                ...
                <div className='flex flex-col'>
                    ...
                    <p className='text-white mt-3'>{isLogin ? "New to flixxit?" : "Already have an account?"}<span onClick={loginHandler} className='ml-2 text-blue-900 font-medium cursor-pointer'>{isLogin ? "Signup" : "Login"}</span></p>
                </div>
            </form>
        </div>
    )
